    ...
    <div style={styles.section}>
      <div style={styles.container}>
        <div style={styles.left}>
          ...
          <p style={styles.text}>
            {lang === "AZ"
              ? "300-dən çox korporativ müştəri yanılmış ola bilməz. Xüsusən də öz biznes və markasına övladı kimi dəyər verirsə."
              : "More than 300 corporate clients can't be wrong. Especially if they value their business and brand like their own child."}
          </p>
        </div>
        <div style={styles.right}>
          ...
          <div style={styles.imageContainer}>
            <img
              src="https://okmedia.az/img-yeni/musterilerin-fikri.jpeg"
              alt="Company Office"
              style={styles.image}
            />
          </div>
