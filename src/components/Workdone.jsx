      ...
      <div style={styles.container}>
        <div style={styles.left}>
          <p style={styles.smallTitle}>
            {lang === "AZ"
              ? "Qısa zamanda təhvil verilən işlərimiz"
              : "Our works delivered in a short time"}
          </p>
          <h2 style={styles.title}>
            {lang === "AZ" ? "Görülən işlər" : "Work done"}
          </h2>
          <p style={styles.text}>
            {lang === "AZ"
              ? "Hazır şablonsuz, unikal dizaynla hazırladığımız vebsaytlarla tanış olun"
              : "Meet the websites we create with unique designs, without ready-made templates."}
          </p>
        </div>
        <div style={styles.right}>
          ...
          <div style={styles.imageContainer}>
            <img
              src="https://okmedia.az/img-yeni/gorulen-isler-copy.jpeg?=19"
              alt="Company Office"
              style={styles.image}
            />
          </div>
